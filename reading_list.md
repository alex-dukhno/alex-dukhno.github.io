 ...
 * [CockroachDB: The Resilient Geo-Distributed SQL Database](https://dl.acm.org/doi/10.1145/3318464.3386134) :open_book:
 ...
 * :red_circle: [Calvin: Fast Distributed Transactions for Partitioned Database Systems](http://cs.yale.edu/homes/thomson/publications/calvin-sigmod12.pdf)
 ...
 * [What Goes Around Comes Around](https://15721.courses.cs.cmu.edu/spring2020/papers/01-intro/whatgoesaround-stonebraker.pdf) :heavy_check_mark:
 * [The BUCKY object-relational benchmark](https://dl.acm.org/doi/10.1145/253262.253283)
 * [The Implementation of Postgres](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.5.5231&rep=rep1&type=pdf)
 * [What’s Really New with NewSQL?](https://15721.courses.cs.cmu.edu/spring2020/papers/01-intro/pavlo-newsql-sigmodrec2016.pdf) :heavy_check_mark:
 * [Squall: Fine-Grained Live Reconfiguration for Partitioned Main Memory Databases](https://sites.cs.ucsb.edu/~vaibhavarora/Squall.pdf)
 * [Towards scalable real-time analytics: An architecture for scale-out of olxp workloads](https://pdfs.semanticscholar.org/f1a4/780f57cb7c1456c735ff6946d7dc0368874c.pdf)
 * [Rethinking main memory oltp recovery](https://hstore.cs.brown.edu/papers/voltdb-recovery.pdf)
 * [The end of an architectural era: (it’s time for a complete rewrite)](http://dslam.cs.umd.edu/vldb07hstore.pdf)
 * [NonStop SQL, a distributed, high-performance, high-availability implementation of sql](https://www.hpl.hp.com/techreports/tandem/TR-87.4.pdf)
 ...
 * [Designing Data-Intensive Applications: The Big Ideas Behind Reliable, Scalable, and Maintainable Systems](https://www.amazon.com/Designing-Data-Intensive-Applications-Reliable-Maintainable/dp/1449373321/) :heavy_check_mark:
 * [Database Internals: A Deep Dive into How Distributed Data Systems Work](https://www.amazon.com/Database-Internals-Deep-Distributed-Systems-dp-1492040347/dp/1492040347) :heavy_check_mark:
 ...
 * :red_circle: [Consistency Tradeoffs in Modern Distributed Database System Design: CAP is Only Part of the Story](https://dl.acm.org/doi/10.1109/MC.2012.33)
 * :red_circle: [Heartbeat: a Timeout-Free Failure Detector for Quiescent Reliable Communication](https://ecommons.cornell.edu/bitstream/handle/1813/7286/97-1631.pdf)
 * :red_circle: [Atomic commit protocols, their integration, and their optimisations in distributed database systems](https://dl.acm.org/doi/10.1504/IJIIDS.2010.035582)
 * :red_circle: [Sequential consistency versus linearizability](https://dl.acm.org/doi/abs/10.1145/176575.176576)
 * :red_circle: [Coordination Avoidance in Database Systems](http://www.vldb.org/pvldb/vol8/p185-bailis.pdf)
 * :red_circle: [Ubiquitous B-Tree](https://dl.acm.org/doi/10.1145/356770.356776)
 * :red_circle: [On scalable and efficient distributed failure detectors](https://dl.acm.org/doi/10.1145/383962.384010)
 * :red_circle: [On the relationship between the atomic commitment and consensus problems](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwjZzYXc4JPrAhWKBhAIHbUrAfAQFjAAegQIAhAB&url=http%3A%2F%2Fwww.cs.toronto.edu%2F~vassos%2Fresearch%2Fpublications%2FH90%2Fpaper.ps.gz&usg=AOvVaw3uBN9BqDtO3JV6BLHwXysS)
 * :red_circle: [The Φ Accrual Failure Detector](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.80.7427&rep=rep1&type=pdf)
 * :red_circle: [Crash Recovery in a Distributed Data Storage System](https://www.microsoft.com/en-us/research/publication/crash-recovery-in-a-distributed-data-storage-system/)
 * :red_circle: [Implementing linearizability at large scale and low latency](https://doi.org/10.1145/2815400.2815416)
 ...
 * :large_blue_circle: [The part-time parliament](https://dl.acm.org/doi/10.1145/279227.279229)
 * :large_blue_circle: [Paxos Made Simple](https://www.microsoft.com/en-us/research/publication/paxos-made-simple/)
 ...
 * :red_circle: [Transactional Information Systems: Theory, Algorithms, and the Practice of Concurrency Control and Recovery](https://www.amazon.com/Transactional-Information-Systems-Algorithms-Concurrency/dp/1558605088) :open_book:
 * :red_circle: [Concurrency Control and Recovery in Database Systems](https://www.amazon.com/exec/obidos/ASIN/0201107155/acmorg-20)
